...
export function getProject(filter = '', cpl = 60) {
  return request('GET', `/project?enzyme_filter=${filter}&cpl=${cpl}`);
}
export function getProjectAll(cpl = 60) {
  return getProject('all', cpl);
}
export function openFile(p) {
  return request('POST', `/open?path=${encodeURIComponent(p)}`);
}
export function saveFile(p) {
  return request('POST', `/save?path=${encodeURIComponent(p)}`);
}
...
export function setROI(s, e) {
  return request('POST', `/roi?s=${s}&e=${e}`);
}
...
export function addFeature(f) {
  return request('POST', '/features', f);
}
...
export function getPrimers() {
  return request('GET', '/primers');
}
export function addPrimer(p) {
  return request('POST', '/primers', p);
}
export function deletePrimer(id) {
